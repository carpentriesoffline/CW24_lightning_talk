...
\begin{frame}
	...
	\begin{columns}[t]
		\begin{column}{0.6\textwidth} % Left column width
			...
			\begin{itemize}
				\item A Python package that includes Python and command-line interfaces and is designed for both maintaining local teaching servers and for local use by individual learners and data science practitioners.
				
				\item Downloads lesson materials for Software-, Data and Library Carpentries.
				
				\item Downloads the most recent versions of installers for essential tools including \textbf{R}, \textbf{Python}, and \textbf{Rstudio}. 
	...
	\begin{block}{Acknowledgements}
		Virnaliz Cruz, Dr. Ethan P. White, Dr. Jannetta S. Steyn, Dr. Colin Sauze, Dr. Abhishek Dasgupta
	\end{block}
\end{frame}
